...
/**
 * print_err - This function is used to print and error message
 * with an exit code of 98
 * @filename: This is the name of the file that caused an error
*/
void print_err(filename)
{
    printf("Error: This is not an ELF file %s\n", filename);
    exit(98);
}

/**
 * main - This is the main function
 * @ac: this is the number of arguments counted
 * @av: This is an array of argument vectors passed
 * return is always 0
*/
...
/**
 * elf_file - is a funtion that checks if the passed in file name is an 
 * ELF file
